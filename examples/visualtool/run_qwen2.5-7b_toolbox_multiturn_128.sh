...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/pfs/training-data/sudongwang/model/Qwen2.5-VL-7B-Instruct \
    ...
    trainer.experiment_name='qwen2.5vl-7b-instruct-deepeyes-128' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=4 \
    trainer.val_before_train=False \
    trainer.save_freq=4 \
    trainer.test_freq=10000 \
    trainer.rollout_data_dir=/pfs/training-data/sudongwang/VideoTool/checkpoints/zoom_in_tool_verl/qwen2.5vl-7b-instruct-deepeyes-128/rollout \
    ...
    trainer.total_epochs=15 $@ | tee /pfs/training-data/sudongwang/VideoTool/checkpoints/zoom_in_tool_verl/qwen2.5vl-7b-instruct-deepeyes-128/tool_debug.log
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen2.5vl-7b-instruct-deepeyes' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=4 \
    trainer.val_before_train=False \
    trainer.save_freq=8 \
    trainer.test_freq=10000 \
    trainer.rollout_data_dir=/pfs/training-data/sudongwang/VideoTool/checkpoints/zoom_in_tool_verl/qwen2.5vl-7b-instruct-deepeyes/rollout \
    ...
    trainer.total_epochs=15 $@ | tee /pfs/training-data/sudongwang/VideoTool/checkpoints/zoom_in_tool_verl/qwen2.5vl-7b-instruct-deepeyes/tool_debug.log 